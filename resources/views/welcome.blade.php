...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body 
    style="background-image: url(' {{'assets/tinder_hero_image.webp'}}'); 
        ...
        <div class="relative min-h-screen bg-black/40 flex flex-col">
            ...
            <center class="m-auto flex flex-col gap-y-10">
                <h3 class="font-bold text-7xl sm:text-8xl text-white">
                    ...
                    <a class="rounded-3xl bg-gradient-to-r from-pink-500 via-orange-500 to-rose-500 text-white text-xl font-bold px-6 p-2.5 max-w-fit mx-auto" 
                        href="{{route('register')}}">
                        Create Account
                    </a>
            </center>
