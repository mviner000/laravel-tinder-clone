            ...
            <aside class="hidden md:flex flex-col bg-gray-100 sm:w-[22rem] w-full">
                ...
                <header class="bg-tinder py-5 flex items-center p-2.5 sticky top-0">
                    ...
                    <div class="ml-auto flex items-center gap-3">
                        <span class="bg-black/40 p-2.5 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-suitcase-lg-fill size-5 text-white" viewBox="0 0 16 16">
                                <path d="M7 0a2 2 0 0 0-2 2H1.5A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14H2a.5.5 0 0 0 1 0h10a.5.5 0 0 0 1 0h.5a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2H11a2 2 0 0 0-2-2zM6 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1zM3 13V3h1v10zm9 0V3h1v10z"/>
                              </svg>
                        </span>
                        <span class="bg-black/40 p-2.5 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-fill size-5 text-white" viewBox="0 0 16 16">
                ...
                <section 
                    ...
                    <header class="flex items-center gap-5 mb-2 p-4 sticky top-0 bg-white z-10">
                        <button 
                            @click="tab='1'" :class="{ 'border-b-2 border-red-500': tab=='1'}"
                            class="font-bold text-sm px-2 pb-1.5">
                            Matches

                            <span class="bg-tinder rounded-full text-xs p-1 px-2 font-bold text-white">
                                12
                            </span>
                        </button>
                        <button 
                            @click="tab='2'" :class="{ 'border-b-2 border-red-500': tab=='2'}"
                            class="font-bold text-sm px-2 pb-1.5">
                            Messages
                            <span class="bg-tinder rounded-full text-xs p-1 px-2 font-bold text-white">
                                3
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                ...
                                <div class="relative">
                                    ...
                                    <span class="-top-6 -right-5 absolute">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot text-red-500 size-12" viewBox="0 0 16 16">
                                            <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"/>
                                        </svg>
                                    </span>

                                    <img src="https://picsum.photos/200/200?random=woman-{{$i}}" alt="image" class="h-36 rounded-lg object-cover">
                               
                                    {{-- name --}}
                                    <h5 class="absolute bottom-2 rounded-lg left-2 text-white font-bold text-xs">
                                        {{fake()->name}}
                                    </h5>
